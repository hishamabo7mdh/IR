...
import os
from sklearn.feature_extraction.text import TfidfVectorizer
from controllers.qurel2 import precision , get_query_id ,recall,get_all_queries,calculate_map,get_avp,calculateMrr
# عمليات تنظيف الداتا
def preprocess_text(text):
    ...
    data_list_covid = covid(data_list_stop)
    data_list_limitzed = lemitizer(data_list_covid)
...
# انشاء متحول يحمل اسم الملف
filename = "dictonery.json"
...
if os.path.exists(filename):
 ...
 # في حال كان الملف غير موجودا قم بالمعالجة ثم احفظ النتجة بملف جديد 
else:
    preprocessed_docs = {doc.doc_id:preprocess_text(doc.abstract)
...
filename_2 = "dictoneryTitle.json"
# في حال كان الملف موجودا قم بتحميله 
...
def get_result(query):
      ...
      alpha = 0.9  # وزن النحتوى
      beta = 0.1  # وزن العنوان
...
# Create a query
#query = 'how has lack of testing availability led to underreporting of true incidence of Covid-19?'
#get_result(query)
#CalculateMap()
